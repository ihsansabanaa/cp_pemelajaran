-- =====================================================
-- SQL File: Connect CP Detail Teknik Elektronika Industri to Konsentrasi Keahlian
-- =====================================================
-- Purpose: Update mata_pelajaran table to link CP Detail Teknik Elektronika Industri 
--          (id_cp = 7) with Konsentrasi Keahlian Teknik Elektronika Industri (id_konsentrasi = 29)
--
...
-- =====================================================
-- Verify CP Detail exists with id_cp = 7
SELECT 
    id_cp,
    id_mapel,
    kode_cp,
...
-- =====================================================
-- Verify Konsentrasi Keahlian "Teknik Elektronika Industri" exists with id_konsentrasi = 29
SELECT 
    id_konsentrasi,
    kode_konsentrasi,
    nama_konsentrasi,
...
WHERE id_konsentrasi = 29;

-- =====================================================
-- SECTION 4: UPDATE - Connect CP Detail to Konsentrasi Keahlian
-- =====================================================
-- Update mata_pelajaran to link with Konsentrasi Keahlian Teknik Elektronika Industri (FASE F)
...
-- SET @mapel_id = (SELECT id_mapel FROM cp_detail WHERE id_cp = 7 LIMIT 1);
-- UPDATE mata_pelajaran SET id_konsentrasi = 29, id_fase = 'F' WHERE id_mapel = @mapel_id;
...
-- =====================================================
-- Show all mata pelajaran currently linked to Teknik Elektronika Industri
SELECT 
    mp.id_mapel,
    mp.nama_mapel,
    mp.id_konsentrasi,
...
-- 6. Test in RPP form:
--    - Select Bidang Keahlian → Program Keahlian → Teknik Elektronika Industri
