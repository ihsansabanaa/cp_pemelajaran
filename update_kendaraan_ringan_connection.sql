-- =====================================================
-- SQL File: Connect CP Detail Teknik Kendaraan Ringan to Konsentrasi Keahlian
-- =====================================================
-- Purpose: Update mata_pelajaran table to link CP Detail Teknik Kendaraan Ringan 
--          (id_cp = 10) with Konsentrasi Keahlian Teknik Kendaraan Ringan (id_konsentrasi = 16)
--
...
-- =====================================================
-- Verify CP Detail exists with id_cp = 10
SELECT 
    id_cp,
    id_mapel,
    kode_cp,
...
-- =====================================================
-- Verify Konsentrasi Keahlian "Teknik Kendaraan Ringan" exists with id_konsentrasi = 16
SELECT 
    id_konsentrasi,
    kode_konsentrasi,
    nama_konsentrasi,
...
WHERE id_konsentrasi = 16;

-- =====================================================
-- SECTION 4: UPDATE - Connect CP Detail to Konsentrasi Keahlian
-- =====================================================
-- Update mata_pelajaran to link with Konsentrasi Keahlian Teknik Kendaraan Ringan (FASE F)
...
-- SET @mapel_id = (SELECT id_mapel FROM cp_detail WHERE id_cp = 10 LIMIT 1);
-- UPDATE mata_pelajaran SET id_konsentrasi = 16, id_fase = 'F' WHERE id_mapel = @mapel_id;
...
-- =====================================================
-- Show all mata pelajaran currently linked to Teknik Kendaraan Ringan
SELECT 
    mp.id_mapel,
    mp.nama_mapel,
    mp.id_konsentrasi,
...
-- 6. Test in RPP form:
--    - Select Bidang Keahlian → Program Keahlian → Teknik Kendaraan Ringan
