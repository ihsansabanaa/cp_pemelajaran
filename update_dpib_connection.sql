-- ============================================
-- UPDATE CP DETAIL DPIB KE KONSENTRASI KEAHLIAN
-- Tanggal: 11 Desember 2025
-- ============================================

-- 1. CEK CP DETAIL DPIB (id_cp = 4)
SELECT 
    id_cp,
    id_mapel,
...
-- 2. CEK MATA PELAJARAN YANG TERHUBUNG DENGAN CP DPIB
SELECT 
    mp.id_mapel,
    mp.nama_mapel,
    mp.jenis_mapel,
...
WHERE mp.id_mapel = (SELECT id_mapel FROM cp_detail WHERE id_cp = 4 LIMIT 1);

-- 3. CEK KONSENTRASI KEAHLIAN DPIB (id_konsentrasi = 6)
SELECT 
    kk.id_konsentrasi,
    kk.nama_konsentrasi,
    pk.nama_program,
...
WHERE kk.id_konsentrasi = 6;

-- ============================================
-- UPDATE KONEKSI
-- ============================================

-- 4. UPDATE id_konsentrasi untuk Mata Pelajaran DPIB
...
SELECT 
    'VERIFIKASI UPDATE DPIB' as info,
    cp.id_cp,
...
-- 6. CEK SEMUA MATA PELAJARAN DI KONSENTRASI DPIB
SELECT 
    mp.id_mapel,
    mp.nama_mapel,
    mp.jenis_mapel,
