-- =====================================================
-- SQL File: Connect CP Detail Teknik Otomasi Industri to Konsentrasi Keahlian
-- =====================================================
-- Purpose: Update mata_pelajaran table to link CP Detail Teknik Otomasi Industri 
--          (id_cp = 11) with Konsentrasi Keahlian Otomasi Industri (id_konsentrasi = 30)
--
-- This ensures CP Detail appears in RPP form when selecting 
-- Konsentrasi Keahlian "Otomasi Industri"
-- =====================================================

-- =====================================================
-- SECTION 1: Check Current CP Detail
-- =====================================================
-- Verify CP Detail exists with id_cp = 11
SELECT 
    id_cp,
    id_mapel,
    kode_cp,
...
-- =====================================================
-- Verify Konsentrasi Keahlian "Otomasi Industri" exists with id_konsentrasi = 30
SELECT 
    id_konsentrasi,
    kode_konsentrasi,
    nama_konsentrasi,
...
WHERE id_konsentrasi = 30;

-- =====================================================
-- SECTION 4: UPDATE - Connect CP Detail to Konsentrasi Keahlian
-- =====================================================
-- Update mata_pelajaran to link with Konsentrasi Keahlian Otomasi Industri (FASE F)
...
-- SET @mapel_id = (SELECT id_mapel FROM cp_detail WHERE id_cp = 11 LIMIT 1);
-- UPDATE mata_pelajaran SET id_konsentrasi = 30, id_fase = 'F' WHERE id_mapel = @mapel_id;
...
-- =====================================================
-- Show all mata pelajaran currently linked to Otomasi Industri
SELECT 
    mp.id_mapel,
    mp.nama_mapel,
    mp.id_konsentrasi,
...
-- 6. Test in RPP form:
--    - Select Bidang Keahlian → Program Keahlian → Otomasi Industri
