...
<body class="min-h-screen flex items-center antialiased relative overflow-hidden">
    ...
    <div class="absolute inset-0 z-0 flex">
        ...
        <div class="w-[40%] bg-white flex items-center justify-center p-6 relative overflow-y-auto">
            <!-- Back to Home Button -->
            <a href="{{ url('/') }}" class="absolute top-6 left-6 flex items-center gap-2 text-gray-600 hover:text-primary transition-colors group z-10">
        ...
        <a href="{{ route('google.login') }}" class="w-full flex items-center justify-center gap-3 px-4 py-3 border-2 border-gray-300 text-gray-700 font-semibold rounded-lg hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary transition-colors">
