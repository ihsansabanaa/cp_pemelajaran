-- ============================================
-- UPDATE CP DETAIL TEKNIK GEOMATIKA KE KONSENTRASI KEAHLIAN
-- Tanggal: 11 Desember 2025
-- ============================================

-- 1. CEK CP DETAIL TEKNIK GEOMATIKA (id_cp = 5)
SELECT 
    id_cp,
    id_mapel,
...
-- 2. CEK MATA PELAJARAN YANG TERHUBUNG DENGAN CP TEKNIK GEOMATIKA
SELECT 
    mp.id_mapel,
    mp.nama_mapel,
    mp.jenis_mapel,
...
WHERE mp.id_mapel = (SELECT id_mapel FROM cp_detail WHERE id_cp = 5 LIMIT 1);

-- 3. CEK KONSENTRASI KEAHLIAN TEKNIK GEOMATIKA (id_konsentrasi = 57)
SELECT 
    kk.id_konsentrasi,
    kk.nama_konsentrasi,
    pk.nama_program,
...
WHERE kk.id_konsentrasi = 57;

-- ============================================
-- UPDATE KONEKSI
-- ============================================

-- 4. UPDATE id_konsentrasi DAN id_fase untuk Mata Pelajaran TEKNIK GEOMATIKA (FASE F)
...
-- SET @mapel_id = (SELECT id_mapel FROM cp_detail WHERE id_cp = 5 LIMIT 1);
-- UPDATE mata_pelajaran SET id_konsentrasi = 57, id_fase = 'F' WHERE id_mapel = @mapel_id;
...
SELECT 
    'VERIFIKASI UPDATE TEKNIK GEOMATIKA' as info,
    cp.id_cp,
...
-- 6. CEK SEMUA MATA PELAJARAN DI KONSENTRASI TEKNIK GEOMATIKA
SELECT 
    mp.id_mapel,
    mp.nama_mapel,
    mp.jenis_mapel,
...
-- WHERE id_mapel = (SELECT id_mapel FROM cp_detail WHERE id_cp = 5 LIMIT 1);
